...
# Remove first 1 million steps as they might be biased towards MDF
sampling = filter(sampling, fMCS > 1e6)
...
ggsave("results/syntrophic.sampling_pca.2x10x9M.png", w=7, h=27, dpi=250)
...
ggsave("results/syntrophic.sampling_pca_compact.2x10x9M.png", w=7, h=4, dpi=250)
...
ggsave(
  "results/syntrophic.sampling_concs.2x10x9M.pdf", gp, w=210/25.4, h=1200/25.4
)
...
ggsave(
  "results/syntrophic.sampling_concs_combo.2x10x9M.pdf",
...
ggsave(
  "results/syntrophic.sampling_dfs.2x10x9M.pdf", gp, w=210/25.4, h=800/25.4
)
...
ggsave(
  "results/syntrophic.sampling_dfs_combo.2x10x9M.pdf",
